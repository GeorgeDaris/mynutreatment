<template>
  <section :class="isSection ? 'block' : ''">
    <NuxtPicture src="/images/landing-page/about.jpeg" alt="Ιωάννα Παπατζανή" width="480" height="556" sizes="sm:800" placeholder :loading="loading" fit="cover" class="profile-picture" />
    <div class="text">
        <h2 class="h1-size">Με λίγα λόγια</h2>
        <div class="prose">
            <p>Προσωπική μου πεποίθηση είναι, μέσω των συνεδριών μας, να υιοθετήσουμε μια καινούργια φιλοσοφία σχετικά με την διατροφή και ένα νέο τρόπο σκέψης, σύμφωνα με τα ιδιαίτερα χαρακτηριστικά και την καθημερινότητα του κάθε ανθρώπου. Δεν επιδιώκουμε, δηλαδή, απλά να σχεδιά-σουμε μια ακόμα δίαιτα την οποία πρέπει να ακολουθεί το άτομο πιστά.</p>
            <p>Μέσω της συνεργασίας μας, θα κατανοήσετε πώς να καλύπτετε τις διατροφικές σας ανάγκες χωρίς άγχος και περιορισμούς</p>
        </div>
    </div>
  </section>
</template>
